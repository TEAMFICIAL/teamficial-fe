...
export const useMyApplications = (applicationStatus: string, page: number, size: number = 3) => {
...
export const useCurrentApplicants = (recruitingStatus: string, page: number, size: number = 3) => {
