...
const EmptyAppliedTeam = () => {
  return (
    <>
      ...
      <div className="body-3 tablet:flex mb-0 mb-7 hidden h-[164px] h-[220px] w-full max-w-[944px] items-center justify-center rounded-2xl bg-gray-200 p-2.5 text-center text-gray-600">
        <span>
